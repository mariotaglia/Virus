subroutine dielectfcn(phiM,prot,epsfcn,Depsfcn)
...
real*8 phiM(N_poorsol,0:dimx+1,0:dimy+1,1-Xulimit:dimz+Xulimit)
...
do iy=1,dimy
do iz=1,dimz
phi(ix,iy,iz)=phi(ix,iy,iz)+phiM(ii,ix,iy,iz)
enddo
enddo
enddo
enddo
